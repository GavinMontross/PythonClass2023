...
def irma_setup():
    ...
    map_bg_img = tkinter.PhotoImage(file="Python/Lab 7/images/atlantic-basin.png")
    ...
    t = turtle.Turtle()
    wn.register_shape("Python/Lab 7/images/hurricane.gif")
    t.shape("Python/Lab 7/images/hurricane.gif")
...
def irma():
    ...
    data = open("Python/Lab 7/data/irma.csv","r")
